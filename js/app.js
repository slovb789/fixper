(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            ...
            new swiper_core_Swiper(".evaluation__swiper", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
    ...
    const tabTitle = document.querySelectorAll("[data-tab-title]");
    ...
    tabButtons.forEach((function(item, index) {
        item.addEventListener("click", (function() {
            ...
            const tabProblem = document.querySelector("#problem-" + index);
            tabProblem.classList.remove("hidden");
        }));
    }));
    const goBack = document.querySelectorAll(".go__back");
    goBack.forEach((function(item) {
        item.addEventListener("click", (function() {
            tabTitle.forEach((function(item) {
                item.classList.remove("hidden");
            }));
            this.closest(".problem__tab-item").classList.add("hidden");
        }));
    }));
    window["FLS"] = true;
    isWebp();
